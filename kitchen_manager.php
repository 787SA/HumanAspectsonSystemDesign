<?php
session_start();
if (!isset($_SESSION['role']) || $_SESSION['role'] !== 'kitchen_manager') {
...
// Handle updating order status and inventory
                    ...
                    <tbody>
                        <?php foreach ($inventoryItems as $item): ?>
                            ...
                            <td data-translate><?= htmlspecialchars($item['product_name']); ?></td>
                                ...
                                <td>
                                    <form method="POST" action="kitchen_manager.php" style="display:inline-block;">
